...
export function VitalsModal({ open, onOpenChange, repo, timelineEvents = [] }: VitalsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden flex flex-col bg-card/95 backdrop-blur-md neon-border-aqua glow-aqua">
        <DialogHeader>
        ...
        <Tabs defaultValue="overview" className="flex-1 overflow-hidden flex flex-col">
          ...
          <TabsContent value="overview" className="flex-1 overflow-y-auto space-y-6 py-4">
